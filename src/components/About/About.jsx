    ...
    <>
      <div className="about__out__container" id="about">
        ...
        <div className="about-body">
          <p data-aos="zoom-in">
          Welcome to Celestia, the awe-inspiring spacial point of Excel 2023, the annual techno-managerial extravaganza hosted by Govt. Model Engineering College, Kochi.
